...
exports.uploadFileToAzureStorage = function (blobServiceInstance, containerName, directoryName, file) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (fs.statSync(file).isFile()) {
      ...
      blobServiceInstance.createBlockBlobFromLocalFile(containerName, (directoryName + '/') + file.replace("dist/control-center/final/", ""), file, options, function (error, result, response) {
